            ...
            success: function (respuesta) {
                if (funcion == 'eliminarLibro') {
                    if (respuesta.mensaje == "ok") {
                        ...
                        Biblioteca.notificaciones('El registro fue eliminado correctamente', 'Congregacion', 'success');
                    } else {
                        Biblioteca.notificaciones('El registro no pudo ser eliminado, hay recursos usandolo', 'Congregacion', 'error');
                    }
