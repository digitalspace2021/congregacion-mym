    ...
    <div class="col-lg-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <form class="form-horizontal" action="{{Route('update_a_libros',$data->id)}}" id="form-general" method="POST" autocomplete="off">
                    @csrf
                    @method('put')
                    <div class="box-body">
                        <div class="form-group">
                            <label for="descripcion" class="col-lg-3 control-label requerido">descripcion</label>
                                <div class="col-lg-8">
                                    <input type="text" name="area" id="descripcion" class="form-control" value="{{old('area',$data->area ?? '' )}}" required>    
                                </div>
                        </div>
                    </div>
