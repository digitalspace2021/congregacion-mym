                        ...
                        <tr>
                           ...
                           <td>
                               <select class="btn bnt-info" name="accion" onchange="window.location.href=this.value;">
                                    ...
                                    <option value="{{asset('admin/documento/crear/')}}/{{$acogido->id}}/acogido">Registrar Documentos</option>
                                </select>
                                <a href="{{asset('admin/documento/listar')}}/{{$acogido->id}}/3">Ver Documentos</a>
                           </td>
                           <td>
