            ...
            <form method="POST" action="{{ asset('admin/hermana/editar') }}">
               ...
               <!-- <div class="form-group row col-md-6">
                ...
                <div class="form-group row col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="date" class="form-control @error('primera_profesion') is-invalid @enderror" value="{{$hermana->primera_profesion}}" name="primera_profesion" required autofocus>
                ...
                <div class="form-group row col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="date" class="form-control @error('profesion_perpetua') is-invalid @enderror" value="{{$hermana->profesion_perpetua}}" name="profesion_perpetua"  autofocus>
                ...
                <div class="form-group row col-md-6">
                    ...
                    <div class="col-md-6">
                        <textarea class="form-control @error('actividad_que_realiza') is-invalid @enderror" name="actividad_que_realiza" required autofocus>{{$hermana->actividad_que_realiza}}</textarea>
