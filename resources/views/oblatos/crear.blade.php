...
@section('title','Crear Oblato de Betania')
@section('scripts')
    ...
    <div class="col-lg-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Crear Oblato de Betania</h3>
                    <div class="box-tools pull-right">
                        <a href="{{asset('/admin/oblato/listar')}}" class="btn btn-block btn-info btn-sm">
                            <i class="fa fa-fw fa-reply-all"></i> Volver al listado
                        </a>
                    </div>  
            </div>
            <form method="POST" action="{{ asset('admin/oblato/crear') }}">
                @csrf
