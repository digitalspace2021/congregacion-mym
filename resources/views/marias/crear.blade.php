...
@section('title','Crear Maria de Betania')
@section('scripts')
    ...
    <div class="col-lg-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Crear Maria de Betania</h3>
            ...
            <form method="POST" action="{{ asset('admin/maria/crear') }}">
                @csrf
               ...
               <!-- <div class="form-group row col-md-6">
                ...
                <div class="form-group row col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="date" class="form-control @error('profesion_perpetua') is-invalid @enderror" name="profesion_perpetua" autofocus>
                ...
                <div class="form-group row col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="date" class="form-control @error('primera_profesion') is-invalid @enderror" name="primera_profesion" required autofocus>
