                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select  class="form-control" name="tipo_usuario" onchange="usuarios(this.value)" required  autofocus>
                            ...
                            <option value="4">Sacerdote</option>
                            <option value="5">Religioso</option>
                            <option value="6">Laico Consagrado</option>
                            <option value="7">Consagrada Martita</option>
                            <option value="8">Oblato de Betania</option>
                            <option value="9">Maria de Betania</option>
                            <option value="10">Otro</option>
                            <option value="11">Usuario Externo</option>
                        </select>
...
function usuarios(code){
    if(code == 11){
        document.getElementById('usuarioExterno').innerHTML = "<input type='text' name='nombre' id='nombreexterno' class='form-control' placeholder='Nombre usuario externo' required><input type='text' name='cedula'' id='cedulaexterna' placeholder='cedula usuario externo' class='form-control' required>";
        $("#usuario").hide();
        $('#usuario').removeAttr("required");
        $("#usuarioExterno").show();
        $('#usuarioExterno').prop("required", true);

    }
    else{
        $("#usuarioExterno").hide();
        $('#usuarioExterno').removeAttr("required");
        $("#usuario").show();
