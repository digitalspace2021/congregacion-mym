...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="box box-primary">
            ...
            <form method="POST" action="{{ asset('admin/empleado/crear') }}">
                @csrf
                ...
                <div class="form-group row col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control @error('nacionalidad') is-invalid @enderror" name="nacionalidad"  autocomplete="nacionalidad" autofocus>
                ...
                <div class="form-group row col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="date" class="form-control @error('fecha_nacimiento') is-invalid @enderror" name="fecha_nacimiento"  autocomplete="fecha_nacimiento" autofocus>
                ...
                <div class="form-group row col-md-6">
                    ...
                    <div class="col-md-6">
                    <textarea class="form-control @error('actividad_que_realiza') is-invalid @enderror" name="actividad_que_realiza" autofocus></textarea>
                ...
                <div class="form-group row col-md-6">
                    ...
                    <div class="col-md-6">
                        <textarea class="form-control @error('observaciones') is-invalid @enderror" name="observaciones"  autocomplete="observaciones" autofocus></textarea>
                ...
                <div class="form-group row col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control @error('direccion') is-invalid @enderror" name="direccion" required autocomplete="direccion" autofocus>
                ...
                <div class="form-group row col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="number" class="form-control @error('telefono') is-invalid @enderror" name="telefono" required autocomplete="fecha_ingreso" autofocus>
                ...
                <div class="form-group row col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="number" class="form-control @error('num_hijos') is-invalid @enderror" name="num_hijos"  autocomplete="num_hijos" autofocus>
                ...
                <div class="form-group row col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="number" class="form-control @error('salario') is-invalid @enderror" name="salario" required autofocus>
                ...
                <div class="form-group row col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control @error('profesion') is-invalid @enderror" name="profesion"  autocomplete="profesion" autofocus>
                ...
                <div class="form-group row col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control @error('cargo') is-invalid @enderror" name="cargo"  autocomplete="cargo" autofocus>
