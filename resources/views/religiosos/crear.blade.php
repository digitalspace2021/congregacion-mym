    ...
    <div class="col-lg-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Crear Religioso</h3>
            ...
            <form method="POST" action="{{ asset('admin/religioso/crear') }}">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <textarea class="form-control @error('actividad que realiza') is-invalid @enderror" name="actividad que realiza"   autofocus></textarea>
